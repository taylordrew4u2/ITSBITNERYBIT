    ...
    private static func attributes(for key: BitBinderEntity) -> [NSAttributeDescription] {
        ...
        case .roastTarget:
            return [
                ...
                attr("instagramHandle", .stringAttributeType, defaultValue: ""),
                attr("tiktokHandle", .stringAttributeType, defaultValue: ""),
                attr("xHandle", .stringAttributeType, defaultValue: ""),
                attr("facebookURL", .stringAttributeType, defaultValue: ""),
                attr("websiteURL", .stringAttributeType, defaultValue: ""),
