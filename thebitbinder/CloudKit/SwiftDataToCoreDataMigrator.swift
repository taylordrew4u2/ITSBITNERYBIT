...
final class SwiftDataToCoreDataMigrator: ObservableObject {
    ...
    private func copyRoastTargets(
        ...
        for t in targets {
            ...
            mo.setValue(t.instagramHandle, forKey: "instagramHandle")
            mo.setValue(t.tiktokHandle, forKey: "tiktokHandle")
            mo.setValue(t.xHandle, forKey: "xHandle")
            mo.setValue(t.facebookURL, forKey: "facebookURL")
            mo.setValue(t.websiteURL, forKey: "websiteURL")
